...
class FluxPercentileRatioMid20(Base):
    ...
    def fit(self, data):
        ...
        F_40_60 = sorted_data[int(F_60_index)] - sorted_data[int(F_40_index)]
        F_5_95 = sorted_data[int(F_95_index)] - sorted_data[int(F_5_index)]
...
class FluxPercentileRatioMid35(Base):
    ...
    def fit(self, data):
        ...
        F_325_675 = sorted_data[int(F_675_index)] - sorted_data[int(F_325_index)]
        F_5_95 = sorted_data[int(F_95_index)] - sorted_data[int(F_5_index)]
...
class FluxPercentileRatioMid50(Base):
    ...
    def fit(self, data):
        ...
        F_25_75 = sorted_data[int(F_75_index)] - sorted_data[int(F_25_index)]
        F_5_95 = sorted_data[int(F_95_index)] - sorted_data[int(F_5_index)]
...
class FluxPercentileRatioMid65(Base):
    ...
    def fit(self, data):
        ...
        F_175_825 = sorted_data[int(F_825_index)] - sorted_data[int(F_175_index)]
        F_5_95 = sorted_data[int(F_95_index)] - sorted_data[int(F_5_index)]
...
class FluxPercentileRatioMid80(Base):
    ...
    def fit(self, data):
        ...
        F_10_90 = sorted_data[int(F_90_index)] - sorted_data[int(F_10_index)]
        F_5_95 = sorted_data[int(F_95_index)] - sorted_data[int(F_5_index)]
